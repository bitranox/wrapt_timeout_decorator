...
since main is loaded again, the decorated function now points to objects that does not exist anymore, therefore You need to put the decorated Classes and functions into another module.
